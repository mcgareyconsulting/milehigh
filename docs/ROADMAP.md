...
project: MHMW
updated: 2026-09-04
verified: origin/main @ 24ecd8d (PR #364 ASAP behaviour)
...
**Open as of 2026-09-04, in handoff order:** BUG-21 (med), BUG-23 (med — stage-cascade
debt, its own branch), BUG-13 (low — unreproduced; instrument first), BUG-14 (low —
**code is on `main`, no iPad test yet**; root cause tracked down — this is a
verification task, not a build task). **BUG-19, BUG-20 and BUG-22 all came off this
list 2026-09-03/04** — BUG-19 on `feature/dwl-bounce-back`, the other two on
`fix/asap-behavior`.
