...
**Open as of 2026-09-04, in handoff order:** BUG-19 (high, active data loss),
BUG-21 (med), BUG-23 (med — stage-cascade debt, its own branch), BUG-13 (low,
reproduce first), BUG-14 (low — **first pass landed, no iPad test yet**; root
cause tracked down). **BUG-20 and BUG-22 came off this list 2026-09-03/04** —
both built on `fix/asap-behavior`.
