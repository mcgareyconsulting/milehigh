...
> [`CURRENT_STYLING_PIN.md`](./CURRENT_STYLING_PIN.md) — full styling document (type, colors, lattice, columns, toolbar, PDF). Prefer it over this handoff when they disagree.
