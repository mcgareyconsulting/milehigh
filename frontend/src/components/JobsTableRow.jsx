                ...
                {columns.map((column) => {
                    ...
                    if (column === 'Fab Order') {
                        ...
                        return (
                            <td
                                key={`${row.id}-${column}`}
                                className={`${paddingClass} py-0.5 whitespace-nowrap text-[10px] align-middle font-medium ${isDuplicateFabOrder ? '' : rowBgClass} border-r border-gray-500 dark:border-slate-800 text-center`}
                    ...
                    if (column === 'Notes') {
                        return (
                            <td
                                key={`${row.id}-${column}`}
                                className={`${paddingClass} py-0.5 text-[10px] align-middle font-medium ${rowBgClass} border-r border-gray-500 dark:border-slate-800 text-center whitespace-normal`}
                                draggable={false}
                                onMouseDown={handleProtectedCellMouseDown}
                            >
                                <textarea
                    ...
                    if (column === 'Job Comp') {
                        return (
                            <td
                                ...
                                className={`${paddingClass} py-0.5 whitespace-nowrap text-[10px] align-middle font-medium ${rowBgClass} border-r border-gray-500 dark:border-slate-800 text-center`}
                                onMouseDown={handleProtectedCellMouseDown}
                            >
                                <input
                                    type="text"
                    ...
                    if (column === 'Start install') {
                        ...
                        return (
                            <td
                                key={`${row.id}-${column}`}
                                className={`${paddingClass} py-0.5 whitespace-nowrap text-[10px] align-middle font-medium ${startInstallBgClass} border-r border-gray-500 dark:border-slate-800 text-center cursor-pointer transition-colors ${updatingStartInstall ? 'opacity-50' : ''}`}
