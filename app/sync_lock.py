...
@milehigh-header
schema_version: 1
purpose: Module-level reentrant lock that serializes Trello webhook processing and the scheduled queue drainer.
exports:
  sync_lock_manager: Global SyncLockManager singleton used by Trello hook + queue paths
