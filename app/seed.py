        ...
        for item in batch_items:
            try:
                ...
                jr = Releases(
                    ...
                    description=safe_truncate_string(excel_data.get("Description"), 256),
                    fab_hrs=safe_float(excel_data.get("Fab Hrs")),
                    install_hrs=safe_float(excel_data.get("Install HRS")),
                    paint_color=safe_truncate_string(excel_data.get("Paint color"), 64),
                    pm=safe_truncate_string(excel_data.get("PM"), 16),
                    by=safe_truncate_string(excel_data.get("BY"), 16),
                    ...
                    job_comp=safe_truncate_string(excel_data.get("Job Comp"), 8),
                    invoiced=safe_truncate_string(excel_data.get("Invoiced"), 8),
                    notes=safe_truncate_string(excel_data.get("Notes"), 256),
